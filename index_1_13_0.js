...
(function () {
    ...
    var price = ethers.utils.parseUnits('16000000000000000', 0);
    ...
    function setTimer() {
        var seconds = Math.trunc((1782782400 - new Date().getTime() / 1000));
        if (seconds < 0) {
    ...
    function setCapitalization() {
        ...
        function setWidth(totalSupply) {
            var eth = (totalSupply / 1e18 * 0.016).toFixed(3);
            ...
            document.getElementById('topCapitalizationBar').style.width = (exg / 6000 * 100) + '%';
        }
    }
